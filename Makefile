...
build-sample-ios:
	(cd sample/ACP*Sample/ios && pod deintegrate && pod install && xcodebuild build -project ACPPlacesSample.xcodeproj -scheme ACPPlacesSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
