...
build-sample-ios:
	(cd sample/ACP*Sample/ios && pod install && xcodebuild build -workspace ACPPlacesSample.xcworkspace -scheme ACPPlacesSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
